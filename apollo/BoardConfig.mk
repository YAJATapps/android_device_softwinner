...
ifeq ($(PRODUCT_BUILD_VENDOR_BOOT_IMAGE),true)
    ...
    BOARD_VENDOR_RAMDISK_KERNEL_MODULES := \
        $(patsubst %.ko,$(PRODUCT_PREBUILT_PATH)/dist/%.ko,$(shell cat device/softwinner/apollo/apollo-p2/system/vendor_ramdisk.modules | sed 's/^\s\+//g;s/\s\+$$//g;/^#/d;/^$$/d'))
endif
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1932738560 # 1.8 GB
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 943718400 # 900 MB
